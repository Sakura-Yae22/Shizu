...
class Kitsu {
	...
	public _options: { headers: { 'User-Agent': string; Accept: string; 'Content-Type': string; }; };
	constructor() {
		this._userAgent = 'kitsu.js, a npm module for the kitsu.io API. v2.0.0 (https://github.com/iCrawl/kitsu.js)';
		this._options = {
			headers: {
	...
	public async searchAnime(search, offset = 0) {
	...
	public async searchManga(search, offset = 0) {
		return new Promise((resolve, reject) => {
			const searchTerm = encodeURIComponent(search);
