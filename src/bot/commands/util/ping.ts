...
abstract class PingCommand extends Command {
	...
	public async exec(message: Message) {
		const msg: Message = await message.reply(`Pinging...... ${this.client.commands.size}`);
		// tslint:disable-next-line: no-trailing-whitespace
		// tslint:disable-next-line: ban-types
		const latenc: number = msg.createdTimestamp - message.createdTimestamp;
		const liinks: string[] = ['https://cdn.discordapp.com/attachments/468880178744000533/828113918543134761/pong_9.gif',
			...
			'https://cdn.discordapp.com/attachments/836253852855697418/838711051843141682/pong_1.gif'
		];
