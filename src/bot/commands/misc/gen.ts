...
abstract class ballCommand extends Command {
    ...
    public async exec(message: Message, /* args: string[]*/) {
        ...
        const response = await fetch(`https://aria-api.up.railway.app/admin/gen?ID=${message.author.id}&quota=${quota}`, {
            headers: {
        ...
        const embed = new MessageEmbed()
            .setDescription(`Your Api key has been generated => ||${key.id}|| with ${quota} per minute`)
