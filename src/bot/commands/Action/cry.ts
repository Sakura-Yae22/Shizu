...
abstract class CryCommand extends Command {
    constructor() {
        super({
            name: 'cry',
            aliases: [],
            description: 'Cry : ) [NSFW should be reported immediately and the command should be be disabled]',
    ...
    public async exec(message: Message) {
        try {
            ...
            const embed = new MessageEmbed().setImage(`${url}`).setDescription(`Aww!! ${message.author} is crying, Pat them`).setColor(`#FFC0CB`)
